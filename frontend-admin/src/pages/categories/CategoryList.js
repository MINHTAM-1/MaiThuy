...
const CategoryList = () => {
    ...
    const fetchCategories = useCallback(async (resetPage = false) => {
        try {
            ...
            if (res.data?.success) {
                ...
                setCategories([]);
                setError("Không tìm thấy loại sản phẩm");
            }
        } catch (err) {
            console.error(err);
    ...
    const handleDelete = async (id) => {
        const confirmed = await confirmToast({ textConfirm: "Bạn có chắc muốn xóa loại sản phẩm này?" });
        if (!confirmed) return;
        ...
        try {
            ...
            setError(err.response?.data?.message || "Lỗi khi xóa loại sản phẩm")
        }
    };
            ...
            <div className="mb-8">
                <div className="flex justify-between items-center">
                    <div>
                        ...
                        <p className="text-gray-600 mt-2">Quản lý danh sách loại sản phẩm trong cửa hàng</p>
                    </div>
                    <Link
            ...
            <div className="bg-white rounded-lg shadow overflow-hidden">
                {!Array.isArray(categories) || categories.length === 0 ? (
                    <div className="text-center py-12">
                        ...
                        <p className="text-gray-500 text-lg mb-4">Không có loại sản phẩm nào</p>
                        <Link
